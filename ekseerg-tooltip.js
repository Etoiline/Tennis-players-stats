...
EETooltip.prototype.initialize = function() {
	...
	this.svg.on("mousemove", function(event, d) {
		var tooltipWidth = $('#' + curtooltipId).width();
		var tooltipHeight = $('#' + curtooltipId).height();
		
		// Standard position
		var mouse = d3.pointer(event);
		var tooltipLeft = svgLeft + mouse[0] - tooltipWidth / 2;
		var tooltipTop = svgTop + mouse[1] - tooltipHeight - 20;
